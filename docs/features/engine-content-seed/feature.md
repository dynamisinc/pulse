...
|---|-------|----------------|--------|-------|
| 01 | Persona cast seed — the engine's minimum viable cast `[backend]` | E8 arch §5/§14 (narrow, engine-scoped; not COR-020/021) | Not Started | #325 |
| 02 | Starter storyline factory — one canned, in-memory storyline `[backend]` | E8 arch §1.1/§6.1 | Not Started | #326 |
| 03 | Loop-registration seed endpoint — `POST /api/ops/seed-engine-content` `[backend]` `[TIER-2]` | E8 arch §1.2/§2/§14, NFR-009 (COR-001, XC-004) | Not Started | #327 |
