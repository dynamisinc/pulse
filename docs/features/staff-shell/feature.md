...
**World:** staff  ·  **Issue:** —  ·  **Status:** decomposed — ready to build
...
|---|-------|----------------|--------|-------|
| 01 | Staff header — lockup, identity badge, clocks, state pill, classification tag | COR-063 / COR-005 / D7-010 | Not Started | — |
| 02 | Toolstrip dock — one shell-owned strip, shell-global + surface zones | D7-011 / COR-063 | Not Started | — |
| 03 | Participant-admin flyout (login triage) | COR-017 | Not Started | — |
| 04 | Preview as participant (staged, read-only, scenario-moment picker) | COR-041 | Not Started | — |
| 05 | Cadence chrome tokens + thumbnail-distinguishability gate | D7-009 | Not Started | — |
