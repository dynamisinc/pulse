...
**Requirements:** SOC-003 (XC-004, COR-018, COR-053)  ·  **Design decisions:** none  ·  **Issue:** #94
...
participant-visible.** Participant-visible timestamps render in **scenario time** (SOC-003, COR-053).
