...
|---|-------|----------------|--------|-------|
| 01 | Frontend session & token wiring (live flip) | COR-012 | Not Started | #304 |
| 02 | Participant sign-in (named account + shared read-only code) | COR-011, COR-015 | Not Started | #305 |
| 03 | Staff sign-in | COR-014 | Not Started | #306 |
| 04 | Wire real login routes + logout (replaces `SignInFallback`) | COR-004, COR-005 (consumed) | Not Started | #307 |
| 05 | UAT bootstrap seam (guarded one-time seed endpoint) | COR-008, COR-011, COR-014, COR-015 (enablement) | Not Started | #308 |
